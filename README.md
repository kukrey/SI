...
Sklep Internetowy z komponentami komputerowymi - Chęć zakupu RAM i płyty głowne
## Kryteria oceny:
1. Pojemnośc ramu
2. RGB np.TAK
3. Cena np. <=6000
...
## Ograniczenie
1. Liczba Modułów(ram) V
3. Kompatybilność typów(ram-płyta) V
4. Ilość slotów na ram w płycie V
